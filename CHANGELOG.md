...
- `deviceId` is now stored with the api
- `listen` yields sync notifications as they arrive

### Changed

- `session` now throws when the token isn't a reMarkable jwt
- deprecated the `uploadHost` option as rawHost is now the same
...
- a `TreeNodeBlock`'s four anchor fields are now one optional `anchor`
...
[unreleased]: https://github.com/erikbrinkman/rmapi-js/compare/v14.0.0...HEAD
...
[12.0.3]: https://github.com/erikbrinkman/rmapi-js/compare/v12.0.2...v12.0.3
[12.0.2]: https://github.com/erikbrinkman/rmapi-js/compare/v12.0.1...v12.0.2
[12.0.1]: https://github.com/erikbrinkman/rmapi-js/compare/v12.0.0...v12.0.1
[12.0.0]: https://github.com/erikbrinkman/rmapi-js/compare/v11.2.0...v12.0.0
